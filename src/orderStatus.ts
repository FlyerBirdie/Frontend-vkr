...
const HINTS: Record<OrderStatus, string> = {
  draft: "Не участвует в POST /api/schedule, пока не переведёте в «В плане» (scheduled).",
  scheduled: "Допущен к расчёту расписания в пределах планового периода и окна заказа.",
  in_progress: "Выполнение идёт; для пересчёта см. правила переходов статусов на backend.",
